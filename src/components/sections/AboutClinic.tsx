...
const aboutCards: {
  ...
  },
  {
    ...
    text: {
      ...
      kk: "Құралдар хаттама бойынша өңделеді, ал ем пациенттің қауіпсіздігі мен жайлылығын ескере отырып жүргізіледі.",
    },
  },
  {
    ...
    text: {
      ...
      kk: "Дәрігер жағдайыңызды, ем нұсқаларын, мерзімін және құнын алдын ала түсіндіреді.",
    },
  },
  {
    ...
    text: {
      ...
      kk: "Тыныш атмосфера, мұқият қарым-қатынас және ұқыпты процедуралар.",
    },
  },
];
