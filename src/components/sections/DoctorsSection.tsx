...
import { MotionListItem, Reveal, TextReveal } from "@/components/motion/MotionPrimitives";
          ...
          <AnimatePresence initial={false}>
            {isLoading
              ? Array.from({ length: 4 }).map((_, index) => (
                  <MotionListItem key={`home-doctor-skeleton-${index}`} index={index}>
                    <HomeDoctorCardSkeleton />
                  </MotionListItem>
                ))
                      ...
                      <div className="flex flex-1 flex-col p-5">
                        ...
                        <BookingModal>
                          ...
                          >
                            ...
                            <ArrowRight className="size-4 transition-transform group-hover/cta:translate-x-1 motion-reduce:transform-none" />
                          </Button>
                        </BookingModal>
                      </div>
                    </article>
