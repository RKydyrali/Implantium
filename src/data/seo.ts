...
export const homeSeo: PageSeoContent = {
  title: {
    ru: "Стоматология в Актау | IMPLANTIUM",
    kk: "Ақтау стоматологиясы | IMPLANTIUM",
  },
  description: {
    ru: "Стоматологическая клиника IMPLANTIUM в Актау: имплантация зубов, брекеты, лечение, удаление, чистка, коронки и протезирование. Запись на консультацию.",
    kk: "Ақтаудағы IMPLANTIUM стоматологиясы: тіс имплантациясы, брекет, тіс емдеу, жұлу, тазалау, қаптама және протездеу. Кеңеске жазылыңыз.",
  },
  keywords: [
    "стоматология Актау",
    "стоматолог Актау",
