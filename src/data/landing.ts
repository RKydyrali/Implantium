...
export const landingCopy = {
  ru: {
    hero: {
      ...
      lineThree: "в Актау",
      subheadline:
        "Зубная клиника в Актау: имплантация зубов, брекеты и лечение зубов — с понятным планом и записью на консультацию.",
  ...
  kk: {
    hero: {
      ...
      subheadline:
        "Ақтау стоматология: тіс имплантациясы, брекет және тіс емдеу — түсінікті жоспармен кеңеске жазылыңыз.",
...
export const landingServices: LandingServicePanel[] = [
  {
    ...
    prices: [
      ...
      { label: { ru: "Коронка на имплант, металлокерамика", kk: "Имплантқа қаптама, металлокерамика" }, value: { ru: "80 000 тг", kk: "80 000 тг" } },
      { label: { ru: "Коронка на имплант, циркон", kk: "Имплантқа қаптама, циркон" }, value: { ru: "90 000 тг", kk: "90 000 тг" } },
    ...
    faqs: [
      ...
      { question: { ru: "Сколько длится установка импланта?", kk: "Имплант орнату қанша уақыт алады?" }, answer: { ru: "Установка одного импланта обычно занимает от 15 минут до часа. Если имплантов несколько, процедура длится от часа.", kk: "Бір имплант орнату әдетте 15 минуттан 1 сағатқа дейін. Импланттар бірнеше болса, процедура 1 сағаттан басталады." } },
      { question: { ru: "Когда ставится коронка?", kk: "Қаптама қашан қойылады?" }, answer: { ru: "Постоянная коронка обычно ставится после приживления импланта.", kk: "Тұрақты қаптама әдетте имплант біткеннен кейін қойылады." } },
    ],
  },
  {
    id: "crowns-panel",
    serviceId: "crowns",
    iconName: "Smiley",
    shortTitle: { ru: "Коронки", kk: "Қаптамалар" },
    title: { ru: "Коронки на зубы", kk: "Тіс қаптамалары" },
    summary: {
    ...
    prices: [
      ...
      { label: { ru: "Съемные протезы на одну челюсть", kk: "Алмалы протездер бір жаққа" }, value: { ru: "от 50 000 тг", kk: "50 000 тг бастап" } },
    ],
    specialists: [
      { title: { ru: "Ортопед", kk: "Ортопед" }, description: { ru: "Подбирает материал, оттенок и конструкцию коронки.", kk: "Қаптаманың материалы, түсі және құрылымын таңдайды." } },
      { title: { ru: "Терапевт-стоматолог", kk: "Стоматолог-терапевт" }, description: { ru: "Готовит зуб к восстановлению, если требуется лечение.", kk: "Қажет болса, тісті қалпына келтіруге дайындайды." } },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    serviceId: "dentures",
    iconName: "Smiley",
    shortTitle: { ru: "Протезы", kk: "Тіс протездері" },
    title: { ru: "Съёмные и несъёмные протезы", kk: "Алмалы және тұрақты протездер" },
    summary: {
    ...
    prices: [
      { label: { ru: "Съёмный протез на одну челюсть", kk: "Бір жаққа алмалы протез" }, value: { ru: "от 50 000 тг", kk: "50 000 тг бастап" } },
      { label: { ru: "Бюгельный протез", kk: "Бюгельді протез" }, value: { ru: "от 120 000 тг", kk: "120 000 тг бастап" } },
      { label: { ru: "Протез на имплантах", kk: "Импланттағы протез" }, value: { ru: "индивидуально", kk: "жеке есеп" } },
    ],
    specialists: [
      { title: { ru: "Ортопед", kk: "Ортопед" }, description: { ru: "Подбирает тип протеза, материал и план лечения.", kk: "Протез түрі, материал және ем жоспарын таңдайды." } },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    specialists: [
      { title: { ru: "Терапевт-стоматолог", kk: "Стоматолог-терапевт" }, description: { ru: "Проводит осмотр, чистку и профилактические рекомендации.", kk: "Тексеру, тазалау және профилактикалық ұсыныстар береді." } },
    ],
    faqs: [
